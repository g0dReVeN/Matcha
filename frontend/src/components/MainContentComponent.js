    ...
    return (
		<Column className={classes.container}>
			<Row vertical="center" horizontal="center">
				<FilterBarComponent label={'Age'} value={[18, 27]} space={'0px 15px 0px 0px'}></FilterBarComponent>
				<FilterBarComponent label={'Location (KM)'} value={[0, 20]} space={'0px 0px 0px 0px'}></FilterBarComponent>
			</Row>
			<Row vertical="center" horizontal="center">
				<FilterBarComponent label={'Fame Rating'} value={[60, 100]} space={'0px 15px 0px 0px'}></FilterBarComponent>
